grunt.registerTask('stagecopy', ['copy:stage', 'copy:deps', 'preprocess', 'stylus']);
grunt.registerTask('build:production', ['env:production', 'clean:productionAppJs', 'stagecopy', 'copy:production', 'concat', 'ngmin:app', 'uglify',  'replace:production', 'cssmin', 'clean:production']);
grunt.registerTask('build:native', ['copy:native', 'exec:cordova:build']);
